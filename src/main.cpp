...
int main(int argc, char** argv) {
   ...
   {
       start = ( clock() - start );
       cout << "Clock(): " << clock() << " Start: " << start << " ClocksPerSec: " << (double)CLOCKS_PER_SEC << "\n";
       ...
       diff = ( start - diff );
       cout << diff << "\n";
       if ((1000/framerate - diff) > 0)
       {
           double sleeptime = (1000/framerate - diff);
           cout << "Sleeping " << sleeptime << "\n";
